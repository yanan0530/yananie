...
class GoodsCategroy(models.Model):
    ...
    parent_category = models.ForeignKey("self", on_delete=models.CASCADE, null=True, blank=True, verbose_name="父类",
                                        related_name="sub_cat")
    is_tab = models.BooleanField(default=False, verbose_name="是否导航", help_text="是否导航")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
    picture = models.ImageField(upload_to='categroy/picture/', max_length=200, null=True, blank=True)
